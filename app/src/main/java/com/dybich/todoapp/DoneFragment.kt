...
class DoneFragment : Fragment() {
    ...
    private lateinit var adapter: Done_Adapter
    ...
    override fun onCreateView(
        ...
        recyclerView = view.findViewById(R.id.Done_RV)
        informationsTV = view.findViewById(R.id.fdone_TV)
        if(savedInstanceState!=null){
            ...
            if(finalList.size > 0){
                ...
                adapter = Done_Adapter(finalList!!)
        ...
        database.child("users").child(uid.toString()).child("manager").get().addOnSuccessListener {manager->
            if(manager.value == "true"){
                database.child("users").child(uid.toString()).child("username").get().addOnSuccessListener {
                    ...
                    val userData=   db.getReference("/managers/$nick/tasks/Done")
                        ...
                        override fun onDataChange(snapshot: DataSnapshot) {
                            ...
                            if(snapshot.exists()){
                                ...
                                if(todotasks.size > 0){
                                    ...
                                    informationsTV.text = "No tasks, please finish one"
                ...
                currUser.addValueEventListener(object : ValueEventListener {
                    override fun onDataChange(snapshot: DataSnapshot) {
                        if(snapshot.value != "null"){
                            ...
                            val userData=   db.getReference("/managers/$leader/tasks/Done")
                            userData.addValueEventListener(object: ValueEventListener {
                                ...
                                override fun onDataChange(snapshot: DataSnapshot) {
                                    ...
                                    if(snapshot.exists()){
                                        ...
                                        informationsTV.text = "No Done tasks found. Finish a task!"
                                        informationsTV.visibility = View.VISIBLE
                                        recyclerView.visibility = View.GONE
                                    }
